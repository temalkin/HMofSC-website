export const serviceData = {
  repairs: {
    drywall_repair: {
      name: 'Drywall Repair',
      options: [
        'Small patch (≤ 2x2 inches)',
        'Medium patch (> 2x2 inches to 12x12 inches)',
        'Large patch (> 12x12 inches)',
        'Ceiling drywall repair (any size)'
      ]
    },
    door_repair: {
      name: 'Door Repair',
  ...
  installations: {
    tv_mounting: {
      ...
      options: [
        ...
        'Large TV (56–75")',
        'Extra-large TV (76"+)',
        'Wall type: Drywall (wood studs)',
        'Wall type: Drywall (metal studs)',
        'Wall type: Brick',
        'Wall type: Concrete'
      ]
    },
    ceiling_fan: {
      ...
      options: [
        ...
        'New electrical box installation needed'
      ]
    },
    light_fixture: {
