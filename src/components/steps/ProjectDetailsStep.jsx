  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        <label htmlFor="project-description" className="block text-lg font-semibold text-gray-800">
          Can you briefly describe the work?
        </label>
        <textarea
          id="project-description"
          placeholder="Tell us about your project, any specific requirements, or concerns..."
