...
const getCharlotteBounds = () => {
  // Approximate bounds around Charlotte/Mecklenburg and nearby ZIPs
  // SW: 35.00, -81.15  NE: 35.50, -80.55
  try {
...
const AddressAutocomplete = ({
  ...
  return (
    <input
      ...
      required={required}
      onKeyDown={(e) => {
        // Let Enter select from dropdown; prevent form submit if suggestions open
        if (e.key === 'Enter' && ready) {
          // noop: Autocomplete handles selection
        }
      }}
    />
  );
